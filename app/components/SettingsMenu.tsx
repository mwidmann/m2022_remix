...
export default function SettingsMenu() {
  ...
  return (
    <div
      className={`absolute inset-0 transform-gpu bg-gray-50/50 filter backdrop-blur-sm transition-all duration-200 neon:bg-neonb-900/50 dark:bg-slate-900/50 ${isMenuOpen ? `z-20 scale-100 opacity-100` : `scale-80 -z-10 opacity-0`
        }`}
